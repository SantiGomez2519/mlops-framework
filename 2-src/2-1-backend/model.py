...
MODEL_PATH = Path(__file__).resolve().parent.parent / "shared" / "models" / "best_model.joblib"
RESULTS_PATH = Path(__file__).resolve().parent.parent / "shared" / "models" / "experiment_results.json"
